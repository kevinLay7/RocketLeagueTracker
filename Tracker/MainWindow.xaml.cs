...
namespace Tracker
{
    public partial class MainWindow : MetroWindow
    {
        ...
        {
            vm.NextUpdate = _trackedUsersManager.NextUpdateTime;
            var span = TimeSpan.FromSeconds((_trackedUsersManager.NextUpdateTime - DateTime.Now).TotalSeconds);
            vm.RefreshTime = "Refresh (" + span.ToString(@"m\:ss") + ")";
        }
